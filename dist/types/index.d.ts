...
export declare type SvelidateFormStore<
	F extends UninitializedForm,
	T = SvelidateForm<F>
> = SvelteStore<T> & {
	set: (value: T) => void
}
export declare type Subscriber = <F extends UninitializedForm>(
	form: SvelidateForm<F>
) => void
export declare type ValidatorWrapper<
	T = unknown,
...
export declare type HtmlValidatorMapper<
...
export declare type HtmlPseudoInputType =
	| "select-multiple"
	| "select-one"
	| "textarea"
export declare type HtmlNumberInputType = "number" | "range"
export declare type HtmlDateTimeInputType =
	| "datetime-local"
	| "date"
	| "month"
	| "week"
	| "time"
export declare type HtmlStringInputType =
	| "text"
	| "tel"
	| "email"
	| "url"
	| "password"
	| "search"
export declare type HtmlInputType =
