...
export declare type HtmlInputType = HtmlDateTimeInputType | HtmlNumberInputType | HtmlStringInputType | HtmlFileInputType | HtmlCheckboxInputType | "color" | "hidden" | "radio" | "reset" | "submit";
export declare type SvelidateInputType = HtmlInputType | HtmlPseudoInputType;
declare type HtmlInputmodeAttribute = "none" | "text" | "decimal" | "numeric" | "tel" | "search" | "email" | "url";
